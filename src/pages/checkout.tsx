...
export default function CheckoutPage() {
  ...
  const validatePaymentInfo = () => {
    if (paymentMethod === "credit-card") {
      const requiredFields = ['nameOnCard', 'cardNumber', 'expirationDate', 'cvv'];
      return requiredFields.every(field => (cardInfo as any)[field].trim() !== "");
    }
        ...
        <div className="mb-8">
          <div className="flex justify-between">
            <div className="flex flex-col items-center">
              <div className={`flex items-center justify-center w-10 h-10 rounded-full ${activeStep >= 1 ? "bg-primary text-primary-foreground" : "bg-muted text-muted-foreground"}`}>
                <User className="h-5 w-5" />
              </div>
              <span className="text-sm mt-2">Shipping</span>
            </div>
            <div className="flex-1 flex items-center mx-4">
              <div className={`h-1 flex-1 ${activeStep >= 2 ? "bg-primary" : "bg-muted"}`}></div>
            </div>
            <div className="flex flex-col items-center">
              <div className={`flex items-center justify-center w-10 h-10 rounded-full ${activeStep >= 2 ? "bg-primary text-primary-foreground" : "bg-muted text-muted-foreground"}`}>
                <CreditCard className="h-5 w-5" />
              </div>
              <span className="text-sm mt-2">Payment</span>
            </div>
            <div className="flex-1 flex items-center mx-4">
              <div className={`h-1 flex-1 ${activeStep >= 3 ? "bg-primary" : "bg-muted"}`}></div>
            </div>
            <div className="flex flex-col items-center">
              <div className={`flex items-center justify-center w-10 h-10 rounded-full ${activeStep >= 3 ? "bg-primary text-primary-foreground" : "bg-muted text-muted-foreground"}`}>
              ...
              <CardContent className="p-6">
                ...
                <div className="space-y-3 mb-6">
                  ...
                  <div className="flex justify-between">
                    ...
                    <span>{totalPrice >= 50 ? "Free" : formatCurrency(5.99)}</span>
                  </div>
                  ...
                  <div className="flex justify-between text-lg font-semibold">
                    <span>Total</span>
                    <span>{formatCurrency(totalPrice + (totalPrice >= 50 ? 0 : 5.99) + totalPrice * 0.07)}</span>
                  </div>
                </div>
